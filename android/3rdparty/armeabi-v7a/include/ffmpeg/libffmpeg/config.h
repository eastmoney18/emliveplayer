...
#define FFMPEG_CONFIGURATION "--arch=arm --cpu=cortex-a8 --disable-neon --enable-thumb --enable-openssl --disable-gpl --disable-nonfree --enable-small --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --disable-avfilter --disable-avresample --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-videotoolbox --disable-encoders --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=h264 --enable-decoder=mpeg4 --enable-decoder=mp3 --disable-hwaccels --enable-decoder=flv --enable-decoder=hevc --disable-muxers --enable-muxer=mp4 --enable-muxer=flv --disable-demuxers --enable-demuxer=aac --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=mov --enable-demuxer=mpegts --enable-demuxer=emmul --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-bsfs --disable-bsf=chomp --disable-bsf=dca_core --disable-bsf=dump_extradata --disable-bsf=hevc_mp4toannexb --disable-bsf=imx_dump_header --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=mp3_header_decompress --disable-bsf=mpeg4_unpack_bframes --disable-bsf=noise --disable-bsf=remove_extradata --disable-bsf=text2movsub --disable-bsf=vp9_superframe --enable-protocols --enable-protocol=async --disable-protocol=bluray --disable-protocol=concat --disable-protocol=crypto --disable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol=icecast --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=md5 --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --enable-protocol=rtmp --enable-protocol=rtmpt --disable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=subfile --disable-protocol=unix --disable-devices --disable-filters --disable-iconv --disable-audiotoolbox --disable-videotoolbox --prefix=/Users/company256g/Documents/EMSDK/common/base/thirdParty/ffmpeg-build/android/build/ffmpeg-armv7a/output --cross-prefix=arm-linux-androideabi- --enable-cross-compile --target-os=linux --enable-pic --enable-asm --enable-inline-asm --enable-optimizations --enable-debug --enable-small --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -I/Users/company256g/Documents/EMSDK/common/base/thirdParty/ffmpeg-build/android/build/openssl-armv7a/output/include -march=armv7-a -mcpu=cortex-a8 -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb' --extra-ldflags=' -L/Users/company256g/Documents/EMSDK/common/base/thirdParty/ffmpeg-build/android/build/openssl-armv7a/output/lib -lssl -lcrypto -Wl,--fix-cortex-a8'"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "/Users/company256g/Documents/EMSDK/common/base/thirdParty/ffmpeg-build/android/build/ffmpeg-armv7a/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/company256g/Documents/EMSDK/common/base/thirdParty/ffmpeg-build/android/build/ffmpeg-armv7a/output/share/ffmpeg"
...
#define CONFIG_AVIO_EM_READING_EXAMPLE 1
...
#define CONFIG_HTTP_PROXY_PROTOCOL 1
#define CONFIG_HTTP_S_PROTOCOL 1
...
#define CONFIG_EMMUL_PROTOCOL 1
