...
public class AndroidMediaPlayer extends AbstractMediaPlayer {
    private final static String TAG = "AndroidMediaPlayer";
    private final int EM_PLAY_PROGRESS = 0x1001;
    ...
    private Handler mHandler = new Handler(Looper.getMainLooper()){
        ...
        public void handleMessage(Message msg) {
            if (msg.what == EM_PLAY_PROGRESS){
                onPlayProgress((int)getCurrentPosition(), (int)getDuration());
                mHandler.sendEmptyMessageDelayed(EM_PLAY_PROGRESS, 200);
            }
        }
    };
    ...
    public void stop() throws IllegalStateException {
        ...
        mHandler.removeMessages(EM_PLAY_PROGRESS);
    }
    ...
    public void setPlaybackRate(float rate) throws IllegalStateException{
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            if (mInternalMediaPlayer.isPlaying()){
                mInternalMediaPlayer.setPlaybackParams(mInternalMediaPlayer.getPlaybackParams().setSpeed(rate));
            }
            else{
                mInternalMediaPlayer.setPlaybackParams(mInternalMediaPlayer.getPlaybackParams().setSpeed(rate));
                mInternalMediaPlayer.pause();
