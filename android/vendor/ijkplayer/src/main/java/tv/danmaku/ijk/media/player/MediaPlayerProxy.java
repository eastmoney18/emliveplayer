...
public class MediaPlayerProxy implements IMediaPlayer {
    ...
    public void setRecordStatus(boolean recordOn) {
        mBackEndMediaPlayer.setRecordStatus(recordOn);
    }
    ...
    @Override
    public void setOnPlayProgressListener(OnVideoPlayProgressListener listener) {

    }

    @Override
    public void setOnPlayStreamUnixTimeListener(OnVideoPlayStreamUnixTimeListener listener) {
