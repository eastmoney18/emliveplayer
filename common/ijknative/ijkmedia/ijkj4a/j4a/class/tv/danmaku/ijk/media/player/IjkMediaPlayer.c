...
typedef struct J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer {
    ...
    jmethodID method_postPresentBufferFromNative;
    jmethodID method_postPresentAudioBufferFromNative;
...
void J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__postPresentBufferFromNative(JNIEnv *env, jobject weakThiz, jint colorFormat, jbyteArray frame, jint width, jint height)
{
    (*env)->CallStaticVoidMethod(env, class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer.id, class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer.method_postPresentBufferFromNative, weakThiz, colorFormat, frame, width, height);
}

void J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__postPresentBufferFromNative__catchAll(JNIEnv *env, jobject weakThiz, jint colorFormat, jbyteArray frame, jint width, jint height)
{
    J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__postPresentBufferFromNative(env, weakThiz, colorFormat, frame, width, height);
    J4A_ExceptionCheck__catchAll(env);
}

void J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__postPresentAudioBufferFromNative(JNIEnv *env, jobject weakThiz, jbyteArray frame, jint length, jint mspts, jint sr, jint channels)
{
    (*env)->CallStaticVoidMethod(env, class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer.id, class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer.method_postPresentAudioBufferFromNative, weakThiz, frame, length, mspts, sr, channels);
}

void J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__postPresentAudioBufferFromNative__catchAll(JNIEnv *env, jobject weakThiz, jbyteArray frame, jint length, jint mspts, jint sr, jint channels)
{
    J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__postPresentAudioBufferFromNative(env, weakThiz, frame, length, mspts, sr, channels);
    J4A_ExceptionCheck__catchAll(env);
}
...
int J4A_loadClass__J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer(JNIEnv *env)
{
    ...
    class_id = class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer.id;
    name     = "postPresentBufferFromNative";
    sign     = "(Ljava/lang/Object;I[BII)V";
    class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer.method_postPresentBufferFromNative = J4A_GetStaticMethodID__catchAll(env, class_id, name, sign);
    if (class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer.method_postPresentBufferFromNative == NULL)
        goto fail;

    class_id = class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer.id;
    name     = "postPresentAudioBufferFromNative";
    sign     = "(Ljava/lang/Object;[BIIII)V";
    class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer.method_postPresentAudioBufferFromNative = J4A_GetStaticMethodID__catchAll(env, class_id, name, sign);
    if (class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer.method_postPresentAudioBufferFromNative == NULL)
        goto fail;
