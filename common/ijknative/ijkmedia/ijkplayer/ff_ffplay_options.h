...
static const AVOption ffp_context_options[] = {
    ...
    { "view-video-first-frame",                  "view first video frame(as cover image.) on prepared",
        OPTION_OFFSET(view_video_first_frame),   OPTION_INT(0, 0, 1) },
    ...
    { "reconnect_count",                    "set auto reconnect count",
        OPTION_OFFSET(reconnect_count),     OPTION_INT(3, 0, INT_MAX)},
    { "reconnect_interval",                    "set auto reconnect interval",
        OPTION_OFFSET(reconnect_interval),     OPTION_INT(1, 0, INT_MAX)},
        // iOS only options
    ...
    { "play_channel_mode",                  "play chanel mode",
        OPTION_OFFSET(play_channel_mode),   OPTION_INT(0, 0, 2),
    },
    { "enable_sonic_handle",                "audio sonic handle:enable",
      OPTION_OFFSET(enable_sonic_handle),    OPTION_INT(0, 0, 1) },

    { "audio_stream_type",                "audio stream typee",
      OPTION_OFFSET(audio_stream_type),    OPTION_INT(3, -1, 10) },
    
    {"probesize", "open stream probe mediastream size(KB)",
        OPTION_OFFSET(probesize), OPTION_INT(5000, 10, 5000)},
    
    {"dns_timeout", "set timeout (in seconds) for dns valid time",
           OPTION_OFFSET(dns_timeout), OPTION_INT(300, 0, INT_MAX)},
    
    {"dns_cache_count", "set count for dns cache size",
           OPTION_OFFSET(dns_cache_count), OPTION_INT(-1, -1, 10000)},
