...
enum media_event_type {
    ...
    MEDIA_PLAY_PROGRESS     = 6,
    MEDIA_PLAY_STREAM_UNIX_TIME = 7, //tx sei unix time
    MEDIA_TIMED_TEXT        = 99,       // not supported yet
    MEDIA_ERROR             = 100,      // arg1, arg2
    MEDIA_INFO              = 200,      // arg1, arg2

    MEDIA_EXIT_READ         = 1000,
...
enum media_error_type {
    ...
    // 3xx
    MEDIA_ERROR_NETWORK_DISCONNECT = 300,
    // -xx
    MEDIA_ERROR_IO          = -1004,
...
enum media_info_type {
    ...
    MEDIA_INFO_VIDEO_FIRST_I_FRAME_DECODED = 4,

    MEDIA_INFO_VIDEO_SOURCE_CHANGED = 5,
    // 7xx
    ...
    MEDIA_INFO_NETWORK_RECONNECT = 710,//just network reconnect when live play
...
typedef struct emmp_mediacodecinfo_context
{
    char mime_type[128];    //< in
    int  profile;           //< in
    int  level;             //< in
    char codec_name[128];   //< out
} emmp_mediacodecinfo_context;
