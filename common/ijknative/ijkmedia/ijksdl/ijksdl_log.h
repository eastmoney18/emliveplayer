...
typedef void (*ijksdl_log_callback)(int level, const char *buf, va_list vl);
...
void ijksdl_log_vprint(int level, const char *, va_list vl);
void ijksdl_log_printf(int level, const char *, ...);
#define VLOG(level, TAG, ...)    ((void)ijksdl_log_vprint(level, __VA_ARGS__))
#define ALOG(level, TAG, ...)    ((void)ijksdl_log_printf(level, __VA_ARGS__))
