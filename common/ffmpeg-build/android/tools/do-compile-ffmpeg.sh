...
FF_MAKE_TOOLCHAIN_FLAGS="$FF_MAKE_TOOLCHAIN_FLAGS --install-dir=$FF_TOOLCHAIN_PATH --force"
...
$AR crv $FF_PREFIX/libijkffmpeg.a  \
    $FF_C_OBJ_FILES \
    $FF_ASM_OBJ_FILES \
#   $FF_DEP_LIBS
#$STRIP $FF_PREFIX/libijkffmpeg.a 
echo ============================================
