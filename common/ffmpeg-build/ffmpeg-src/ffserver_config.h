...
typedef struct FFServerStream {
    ...
    AVEMDictionary *in_opts;        /* input parameters */
    AVEMDictionary *metadata;       /* metadata to set on the stream */
    AVEMInputFormat *ifmt;          /* if non NULL, force input format */
    ...
    int send_on_key;
    AVEMStream *streams[FFSERVER_MAX_STREAMS];
...
typedef struct FFServerConfig {
    ...
    enum AVEMCodecID guessed_audio_codec_id;
    enum AVEMCodecID guessed_video_codec_id;
    AVEMDictionary *video_opts;     /* AVOptions for video encoder */
    AVEMDictionary *audio_opts;     /* AVOptions for audio encoder */
    AVEMCodecContext *dummy_actx;   /* Used internally to test audio AVOptions. */
    AVEMCodecContext *dummy_vctx;   /* Used internally to test video AVOptions. */
    int no_audio;
    int no_video;
    int line_num;
