...
void em_float_dsp_init_aarch64(AVFloatDSPContext *fdsp);
void em_float_dsp_init_arm(AVFloatDSPContext *fdsp);
void em_float_dsp_init_ppc(AVFloatDSPContext *fdsp, int strict);
void em_float_dsp_init_x86(AVFloatDSPContext *fdsp);
void em_float_dsp_init_mips(AVFloatDSPContext *fdsp);
 ...
 */
AVFloatDSPContext *avpriv_em_float_dsp_alloc(int strict);
