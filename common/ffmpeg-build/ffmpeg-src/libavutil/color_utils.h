 ...
 */
double avpriv_em_get_gamma_from_trc(enum AVColorTransferCharacteristic trc);
 ...
 *         return NULL:
 */
avpriv_trc_function avpriv_em_get_trc_function_from_trc(enum AVColorTransferCharacteristic trc);
