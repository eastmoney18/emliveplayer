...
#define avpriv_em_atomic_int_get atomic_int_get_win32
...
#define avpriv_em_atomic_int_set atomic_int_set_win32
...
#define avpriv_em_atomic_int_add_and_fetch atomic_int_add_and_fetch_win32
static inline int atomic_int_add_and_fetch_win32(volatile int *ptr, int inc)
{
    return inc + InterlockedExchangeAdd(ptr, inc);
}

#define avpriv_em_atomic_ptr_cas atomic_ptr_cas_win32
