 ...
 *
 * It must be freed with av_em_opencl_free_device_list().
 *
 * @param device_list pointer to OpenCL environment device list,
 *                    should be released by av_em_opencl_free_device_list()
 *
...
/**
  ...
  *
  * @param device_list pointer to OpenCL environment device list
  *                       created by av_em_opencl_get_device_list()
  */
 ...
 *                         written, must be freed with av_em_freep()
 * @return  >=0 on success, a negative error code in case of failure
 * @see av_em_opencl_set_option()
 */
 ...
 *
 * It must be freed with av_em_opencl_free_external_env().
 *
 ...
 *                       created by av_em_opencl_alloc_external_env()
 */
 ...
 *  in the runtime environment when av_em_opencl_init() is called.
 *
 ...
 * kernel.
 * The created buffer must be released with av_em_opencl_buffer_release().
 *
 ...
 *               previously filled with av_em_opencl_buffer_create()
 */
 ...
 * of failure
 */
int64_t av_em_opencl_benchmark(AVOpenCLDeviceNode *device, cl_platform_id platform,
