 ...
 */
int avpriv_em_atomic_int_get(volatile int *ptr);
 ...
 * @note This acts as a memory barrier.
 */
void avpriv_em_atomic_int_set(volatile int *ptr, int val);
 ...
 */
int avpriv_em_atomic_int_add_and_fetch(volatile int *ptr, int inc);
 ...
 */
void *avpriv_em_atomic_ptr_cas(void * volatile *ptr, void *oldval, void *newval);
