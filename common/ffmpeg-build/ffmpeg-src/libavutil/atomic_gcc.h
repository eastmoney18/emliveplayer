...
#define avpriv_em_atomic_int_get atomic_int_get_gcc
...
#define avpriv_em_atomic_int_set atomic_int_set_gcc
...
#define avpriv_em_atomic_int_add_and_fetch atomic_int_add_and_fetch_gcc
...
#define avpriv_em_atomic_ptr_cas atomic_ptr_cas_gcc
