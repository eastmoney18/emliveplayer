...
av_pixelutils_sad_fn av_em_pixelutils_get_sad_fn(int w_bits, int h_bits, int aligned, void *log_ctx)
{
#if !CONFIG_PIXELUTILS
    av_em_log(log_ctx, AV_LOG_ERROR, "pixelutils support is required "
...
#if ARCH_X86
    em_pixelutils_sad_init_x86(sad, aligned);
#endif
