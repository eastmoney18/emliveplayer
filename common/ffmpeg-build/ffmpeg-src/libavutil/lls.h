...
void avpriv_em_init_lls(LLSModel *m, int indep_count);
void em_init_lls_x86(LLSModel *m);
void avpriv_em_solve_lls(LLSModel *m, double threshold, unsigned short min_order);
