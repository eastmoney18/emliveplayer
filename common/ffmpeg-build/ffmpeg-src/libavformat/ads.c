...
static int ads_probe(AVEMProbeData *p)
{
...
static int ads_read_header(AVEMFormatContext *s)
{
...
static int ads_read_packet(AVEMFormatContext *s, AVEMPacket *pkt)
{
...
AVEMInputFormat ff_ads_demuxer = {
    .name           = "ads",
