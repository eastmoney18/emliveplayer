 ...
 * @param first_stream_of_set_idx index to the first AVEMStream in the RTSP
 ...
 */
RDTDemuxContext *ff_rdt_parse_open(AVEMFormatContext *ic,
 ...
 */
int ff_rdt_parse_packet(RDTDemuxContext *s, AVEMPacket *pkt,
                        uint8_t **buf, int len);

/**
 * Parse a server-related SDP line.
 *
 * @param s the RTSP AVEMFormatContext
 ...
 */
void ff_real_parse_sdp_a_line(AVEMFormatContext *s, int stream_index,
                              const char *buf);
