...
int ff_raw_write_packet(AVEMFormatContext *s, AVEMPacket *pkt)
{
    avio_em_write(s->pb, pkt->data, pkt->size);
    return 0;
}

static int force_one_stream(AVEMFormatContext *s)
{
    if (s->nb_streams != 1) {
        av_em_log(s, AV_LOG_ERROR, "%s files have exactly one stream\n",
               s->oformat->name);
...
static int adx_write_trailer(AVEMFormatContext *s)
{
...
AVEMOutputFormat ff_cavsvideo_muxer = {
    .name              = "cavsvideo",
...
AVEMOutputFormat ff_data_muxer = {
    .name              = "data",
...
AVEMOutputFormat ff_dirac_muxer = {
    .name              = "dirac",
...
AVEMOutputFormat ff_dnxhd_muxer = {
    .name              = "dnxhd",
...
AVEMOutputFormat ff_eac3_muxer = {
    .name              = "eac3",
...
AVEMOutputFormat ff_g722_muxer = {
    .name              = "g722",
...
AVEMOutputFormat ff_g723_1_muxer = {
    .name              = "g723_1",
...
AVEMOutputFormat em_h261_muxer = {
    .name              = "h261",
...
AVEMOutputFormat em_h263_muxer = {
    .name              = "h263",
...
AVEMOutputFormat em_h264_muxer = {
    .name              = "h264",
...
AVEMOutputFormat em_hevc_muxer = {
    .name              = "hevc",
...
AVEMOutputFormat ff_mjpeg_muxer = {
    .name              = "mjpeg",
...
AVEMOutputFormat ff_singlejpeg_muxer = {
    .name              = "singlejpeg",
...
AVEMOutputFormat ff_mpeg1video_muxer = {
    .name              = "mpeg1video",
...
AVEMOutputFormat ff_mpeg2video_muxer = {
    .name              = "mpeg2video",
...
AVEMOutputFormat ff_rawvideo_muxer = {
    .name              = "rawvideo",
...
AVEMOutputFormat ff_truehd_muxer = {
    .name              = "truehd",
