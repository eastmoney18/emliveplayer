...
static int svag_probe(AVEMProbeData *p)
{
...
static int svag_read_header(AVEMFormatContext *s)
{
    unsigned size, align;
    AVEMStream *st;
...
static int svag_read_packet(AVEMFormatContext *s, AVEMPacket *pkt)
{
...
AVEMInputFormat ff_svag_demuxer = {
    .name           = "svag",
