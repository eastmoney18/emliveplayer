 ...
 * so we send a Receiver Report to the provided EMURLContext or AVEMIOContext
 ...
 */
typedef int (*DynamicPayloadPacketHandlerProc)(AVEMFormatContext *ctx,
                                               PayloadContext *s,
...
struct RTPDynamicProtocolHandler {
    ...
    int (*init)(AVEMFormatContext *s, int st_index, PayloadContext *priv_data);
    /** Parse the a= line from the sdp field */
    int (*parse_sdp_a_line)(AVEMFormatContext *s, int st_index,
