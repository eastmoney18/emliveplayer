...
static int v210_read_header(AVEMFormatContext *ctx)
{
    ...
    ret = av_em_image_check_size(s->width, s->height, 0, ctx);
    if (ret < 0)
        return ret;
...
static int v210_read_packet(AVEMFormatContext *s, AVEMPacket *pkt)
{
    int ret;
...
static const AVEMClass v210_demuxer_class = {
...
AVEMInputFormat ff_v210_demuxer = {
    .name           = "v210",
...
static const AVEMClass v210x_demuxer_class = {
...
AVEMInputFormat ff_v210x_demuxer = {
    .name           = "v210x",
    .long_name      = NULL_IF_CONFIG_SMALL("Uncompressed 4:2:2 10-bit"),
    .priv_data_size = sizeof(V210DemuxerContext),
    .read_header    = v210_read_header,
