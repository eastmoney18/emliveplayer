...
extern const AVEMCodecTag ff_nut_subtitle_tags[];
extern const AVEMCodecTag ff_nut_video_tags[];
extern const AVEMCodecTag ff_nut_audio_tags[];
extern const AVEMCodecTag ff_nut_audio_extra_tags[];
extern const AVEMCodecTag ff_nut_data_tags[];

extern const AVEMCodecTag * const ff_nut_codec_tags[];
