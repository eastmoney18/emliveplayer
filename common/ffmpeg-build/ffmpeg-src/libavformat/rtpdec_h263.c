                          ...
                          const uint8_t *buf, int len, uint16_t seq, int flags)
{
    ...
    if (len < 2) {
        av_em_log(ctx, AV_LOG_ERROR, "Too short H.263 RTP packet\n");
    ...
    if (av_em_new_packet(pkt, len + startcode)) {
...
RTPDynamicProtocolHandler em_h263_1998_dynamic_handler = {
    .enc_name         = "H263-1998",
    .codec_type       = AVMEDIA_TYPE_VIDEO,
    .codec_id         = AV_CODEC_ID_H263,
    .need_parsing     = AVSTREAM_PARSE_FULL,
    .parse_packet     = em_h263_handle_packet,
};

RTPDynamicProtocolHandler em_h263_2000_dynamic_handler = {
    .enc_name         = "H263-2000",
    .codec_type       = AVMEDIA_TYPE_VIDEO,
    .codec_id         = AV_CODEC_ID_H263,
    .need_parsing     = AVSTREAM_PARSE_FULL,
