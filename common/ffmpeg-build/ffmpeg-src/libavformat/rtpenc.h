...
void ff_rtp_send_h264_hevc(AVEMFormatContext *s1, const uint8_t *buf1, int size);
void ff_rtp_send_h261(AVEMFormatContext *s1, const uint8_t *buf1, int size);
void ff_rtp_send_h263(AVEMFormatContext *s1, const uint8_t *buf1, int size);
void ff_rtp_send_h263_rfc2190(AVEMFormatContext *s1, const uint8_t *buf1, int size,
                              const uint8_t *mb_info, int mb_info_size);
void ff_rtp_send_aac(AVEMFormatContext *s1, const uint8_t *buff, int size);
void ff_rtp_send_latm(AVEMFormatContext *s1, const uint8_t *buff, int size);
void ff_rtp_send_amr(AVEMFormatContext *s1, const uint8_t *buff, int size);
void ff_rtp_send_mpegvideo(AVEMFormatContext *s1, const uint8_t *buf1, int size);
void ff_rtp_send_xiph(AVEMFormatContext *s1, const uint8_t *buff, int size);
void ff_rtp_send_vc2hq(AVEMFormatContext *s1, const uint8_t *buf, int size, int interlaced);
void ff_rtp_send_vp8(AVEMFormatContext *s1, const uint8_t *buff, int size);
void ff_rtp_send_vp9(AVEMFormatContext *s1, const uint8_t *buff, int size);
void ff_rtp_send_jpeg(AVEMFormatContext *s1, const uint8_t *buff, int size);

const uint8_t *em_h263_find_resync_marker_reverse(const uint8_t *av_restrict start,
