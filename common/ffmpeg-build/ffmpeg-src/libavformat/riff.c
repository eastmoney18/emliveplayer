 ...
 */
const AVEMCodecTag em_codec_bmp_tags[] = {
...
const AVEMCodecTag em_codec_wav_tags[] = {
...
const AVMetadataConv em_riff_info_conv[] = {
    { "IART", "artist"     },
    { "ICMT", "comment"    },
    { "ICOP", "copyright"  },
    { "ICRD", "date"       },
...
{
    return em_codec_bmp_tags;
}

const struct AVEMCodecTag *avformat_em_get_riff_audio_tags(void)
{
    return em_codec_wav_tags;
}

const AVEMCodecGuid em_codec_wav_guids[] = {
