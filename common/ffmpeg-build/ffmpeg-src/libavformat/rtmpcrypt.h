 ...
 *
 * @param h     an EMURLContext
 * @param buf   handshake data (1536 bytes)
 * @return zero on success, negative value otherwise
 */
int ff_rtmpe_gen_pub_key(EMURLContext *h, uint8_t *buf);
 ...
 * @return zero on success, negative value otherwise
 */
int ff_rtmpe_compute_secret_key(EMURLContext *h, const uint8_t *serverdata,
 ...
 */
void ff_rtmpe_encrypt_sig(EMURLContext *h, uint8_t *signature,
 ...
 * @return zero on success, negative value otherwise
 */
int ff_rtmpe_update_keystream(EMURLContext *h);
