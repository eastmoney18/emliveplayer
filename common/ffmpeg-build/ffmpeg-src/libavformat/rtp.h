 ...
 * Dynamic payload type are derived from the id field in AVEMStream.
 ...
 */
int ff_rtp_get_payload_type(AVEMFormatContext *fmt, AVEMCodecParameters *par,
                            int idx);
...
#define NTP_TO_RTP_FORMAT(x) av_em_rescale((x), INT64_C(1) << 32, 1000000)
