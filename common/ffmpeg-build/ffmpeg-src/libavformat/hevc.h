...
/**
 * Writes Annex B formatted HEVC NAL units to the provided AVEMIOContext.
 *
 ...
 *
 * @param pb address of the AVEMIOContext where the data shall be written
 ...
 * provided AVEMIOContext.
 *
 * If the extradata is Annex B format, it gets converted to hvcC format before
 * writing.
 *
 * @param pb address of the AVEMIOContext where the hvcC shall be written
