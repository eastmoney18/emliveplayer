...
#define REGISTER_MUXER(X, x)                                            \
    {                                                                   \
        extern AVEMOutputFormat em_##x##_muxer;                           \
        if (CONFIG_##X##_MUXER)                                         \
            av_em_register_output_format(&em_##x##_muxer);                 \
    }

#define REGISTER_DEMUXER(X, x)                                          \
    {                                                                   \
        extern AVEMInputFormat em_##x##_demuxer;                          \
        if (CONFIG_##X##_DEMUXER)                                       \
            av_em_register_input_format(&em_##x##_demuxer);                \
    }
