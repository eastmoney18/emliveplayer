...
static int pcm_read_header(AVEMFormatContext *s)
{
...
static const AVEMClass name_ ## _demuxer_class = {            \
    .class_name = #name_ " demuxer",                        \
    .item_name  = av_em_default_item_name,                     \
    .option     = pcm_options,                              \
    .version    = LIBAVUTIL_VERSION_INT,                    \
};                                                          \
AVEMInputFormat ff_pcm_ ## name_ ## _demuxer = {              \
    .name           = #name_,                               \
...
static const AVEMClass sln_demuxer_class = {
...
AVEMInputFormat ff_sln_demuxer = {
    .name           = "sln",
