...
/* isom.c */
extern const AVEMCodecTag em_mp4_obj_type[];
extern const AVEMCodecTag em_codec_movvideo_tags[];
extern const AVEMCodecTag em_codec_movaudio_tags[];
extern const AVEMCodecTag em_codec_movsubtitle_tags[];
