...
static void vdpau_uninit(AVEMCodecContext *s)
{
...
static int vdpau_get_buffer(AVEMCodecContext *s, AVFrame *frame, int flags)
{
    InputStream         *ist = s->opaque;
    VDPAUContext        *ctx = ist->hwaccel_ctx;
...
static int vdpau_retrieve_data(AVEMCodecContext *s, AVFrame *frame)
{
    InputStream        *ist = s->opaque;
    VDPAUContext       *ctx = ist->hwaccel_ctx;
    int ret;
...
static int vdpau_alloc(AVEMCodecContext *s)
{
    InputStream  *ist = s->opaque;
