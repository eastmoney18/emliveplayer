...
static int pam_encode_frame(AVEMCodecContext *avctx, AVEMPacket *pkt,
                            const AVFrame *p, int *got_packet)
{
    ...
    if ((ret = em_alloc_packet2(avctx, pkt, n*h + 200, 0)) < 0)
        return ret;
...
static av_cold int pam_encode_init(AVEMCodecContext *avctx)
{
