...
static void fill_picture_parameters(AVEMCodecContext *avctx,
                                    AVDXVAContext *ctx,
...
static void fill_quantization_matrices(AVEMCodecContext *avctx,
                                       AVDXVAContext *ctx,
                                       const struct MpegEncContext *s,
                                       DXVA_QmatrixData *qm)
{
...
static void fill_slice(AVEMCodecContext *avctx,
                       const struct MpegEncContext *s,
...
static int dxva2_mpeg2_start_frame(AVEMCodecContext *avctx,
...
static int dxva2_mpeg2_decode_slice(AVEMCodecContext *avctx,
                                    const uint8_t *buffer, uint32_t size)
{
    ...
    if (ctx_pic->slice_count >= MAX_SLICES) {
        avpriv_em_request_sample(avctx, "%d slices in dxva2",
                              ctx_pic->slice_count);
        return -1;
    }
...
static int dxva2_mpeg2_end_frame(AVEMCodecContext *avctx)
{
