                        ...
                        int *got_frame, AVEMPacket *avpkt)
{
    ...
    if (avctx->bits_per_coded_sample <= 8) {
        const uint8_t *pal = av_em_packet_get_side_data(avpkt,
                                                     AV_PKT_DATA_PALETTE,
                                                     NULL);
        if (pal) {
...
static av_cold int decode_init(AVEMCodecContext *avctx)
{
    ...
    case 8:
        ...
        break;
    case 24:
        avctx->pix_fmt = em_get_format(avctx, pixfmt_rgb24);
        c->planes      = 3;
    ...
    case 32:
        ...
        break;
    default:
        av_em_log(avctx, AV_LOG_ERROR, "Error: Unsupported color depth: %u.\n",
