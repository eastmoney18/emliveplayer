 ...
 *
 * This table was generated from the long and short names of AVEMCodecs
...
static const AVEMCodecDescriptor codec_descriptors[] = {
    /* video codecs */
    {
...
{
    const AVEMCodecDescriptor *desc = NULL;

    while ((desc = avcodec_em_descriptor_next(desc)))
