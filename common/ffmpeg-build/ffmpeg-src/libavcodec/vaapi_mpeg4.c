...
static int vaapi_mpeg4_start_frame(AVEMCodecContext *avctx, av_unused const uint8_t *buffer, av_unused uint32_t size)
{
...
static int vaapi_mpeg4_decode_slice(AVEMCodecContext *avctx, const uint8_t *buffer, uint32_t size)
{
...
AVHWAccel em_mpeg4_vaapi_hwaccel = {
    .name           = "mpeg4_vaapi",
...
AVHWAccel em_h263_vaapi_hwaccel = {
    .name           = "h263_vaapi",
    .type           = AVMEDIA_TYPE_VIDEO,
    .id             = AV_CODEC_ID_H263,
    .pix_fmt        = AV_PIX_FMT_VAAPI,
