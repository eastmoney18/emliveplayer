...
static av_cold int ra144_encode_close(AVEMCodecContext *avctx)
{
...
static av_cold int ra144_encode_init(AVEMCodecContext * avctx)
{
    RA144Context *ractx;
    int ret;
...
static int ra144_encode_frame(AVEMCodecContext *avctx, AVEMPacket *avpkt,
                              const AVFrame *frame, int *got_packet_ptr)
{
    ...
    if ((ret = em_alloc_packet2(avctx, avpkt, FRAME_SIZE, 0)) < 0)
        return ret;
