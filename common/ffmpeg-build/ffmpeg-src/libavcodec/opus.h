...
int ff_opus_parse_extradata(AVEMCodecContext *avctx, OpusContext *s);

int ff_silk_init(AVEMCodecContext *avctx, SilkContext **ps, int output_channels);
...
int ff_celt_init(AVEMCodecContext *avctx, CeltContext **s, int output_channels);
