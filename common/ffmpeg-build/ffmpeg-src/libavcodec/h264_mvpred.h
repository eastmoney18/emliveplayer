...
static av_always_inline int fetch_diagonal_mv(const H264EMContext *h, H264SliceContext *sl,
                                              const int16_t **C,
 ...
 */
static av_always_inline void pred_motion(const H264EMContext *const h,
                                         H264SliceContext *sl,
                                         int n,
 ...
 * @param my the y component of the predicted motion vector
 */
static av_always_inline void pred_16x8_motion(const H264EMContext *const h,
                                              H264SliceContext *sl,
 ...
 * @param my the y component of the predicted motion vector
 */
static av_always_inline void pred_8x16_motion(const H264EMContext *const h,
                                              H264SliceContext *sl,
                                              int n, int list, int ref,
                                              int *const mx, int *const my)
{
...
static av_always_inline void pred_pskip_motion(const H264EMContext *const h,
                                               H264SliceContext *sl)
{
...
static void fill_decode_neighbors(const H264EMContext *h, H264SliceContext *sl, int mb_type)
{
...
static void fill_decode_caches(const H264EMContext *h, H264SliceContext *sl, int mb_type)
{
    int topleft_xy, top_xy, topright_xy, left_xy[LEFT_MBS];
 ...
 */
static void av_unused decode_mb_skip(const H264EMContext *h, H264SliceContext *sl)
{
    const int mb_xy = sl->mb_xy;
    int mb_type     = 0;
