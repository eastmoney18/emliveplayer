...
int ff_wmv2_decode_picture_header(MpegEncContext *s)
{
    ...
    if (s->pict_type == AV_PICTURE_TYPE_I) {
        ...
        av_em_log(s->avctx, AV_LOG_DEBUG, "I7:%X/\n", code);
    }
...
static av_cold int wmv2_decode_init(AVEMCodecContext *avctx)
{
...
static av_cold int wmv2_decode_end(AVEMCodecContext *avctx)
{
    Wmv2Context *w = avctx->priv_data;

    ff_intrax8_common_end(&w->x8);
    return em_h263_decode_end(avctx);
}

AVEMCodec ff_wmv2_decoder = {
    .name           = "wmv2",
