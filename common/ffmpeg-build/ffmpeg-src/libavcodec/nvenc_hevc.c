...
{
    av_em_log(avctx, AV_LOG_WARNING, "This encoder is deprecated, use 'hevc_nvenc' instead\n");
    return ff_nvenc_encode_init(avctx);
}

static const AVEMClass nvenc_hevc_class = {
...
AVEMCodec ff_nvenc_hevc_encoder = {
    .name           = "nvenc_hevc",
...
static const AVEMClass hevc_nvenc_class = {
...
AVEMCodec em_hevc_nvenc_encoder = {
    .name           = "hevc_nvenc",
    .long_name      = NULL_IF_CONFIG_SMALL("NVIDIA NVENC hevc encoder"),
    .type           = AVMEDIA_TYPE_VIDEO,
    .id             = AV_CODEC_ID_HEVC,
