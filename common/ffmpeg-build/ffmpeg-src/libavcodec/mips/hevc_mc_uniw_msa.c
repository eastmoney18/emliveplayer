...
void em_hevc_put_hevc_uni_w_pel_pixels##WIDTH##_8_msa(uint8_t *dst,          \
...
void em_hevc_put_hevc_uni_w_##PEL##_##DIR##WIDTH##_8_msa(uint8_t *dst,        \
                                                           ...
                                                           int width)         \
{                                                                             \
    const int8_t *filter = em_hevc_##PEL##_filters[FILT_DIR - 1];             \
    int shift = denom + 14 - 8;                                               \
                                                                              \
...
void em_hevc_put_hevc_uni_w_##PEL##_##DIR##WIDTH##_8_msa(uint8_t *dst,       \
                                                           ...
                                                           int width)        \
{                                                                            \
    const int8_t *filter_x = em_hevc_##PEL##_filters[mx - 1];                \
    const int8_t *filter_y = em_hevc_##PEL##_filters[my - 1];                \
    int shift = denom + 14 - 8;                                              \
                                                                             \
    hevc_##DIR1##_uniwgt_##TAP##t_##WIDTH##w_msa(src, src_stride, dst,       \
                                                 dst_stride, filter_x,       \
