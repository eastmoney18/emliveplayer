                                  ...
                                  uint32_t coef_ver0, uint32_t coef_ver1)
{
    ...
    v8i16 res_vert;
    v16i8 mask;
    v16i8 coeem_hz_vec0 = __msa_fill_b(coef_hor0);
    v16i8 coeem_hz_vec1 = __msa_fill_b(coef_hor1);
    v16u8 coeem_hz_vec = (v16u8) __msa_ilvr_b(coeem_hz_vec0, coeem_hz_vec1);
    ...
    DOTP_UB2_UH(src0, src1, coeem_hz_vec, coeem_hz_vec, res_hz0, res_hz1);
                                  ...
                                  uint32_t coef_ver0, uint32_t coef_ver1)
{
    ...
    DOTP_UB2_UH(src4, src5, coeem_hz_vec, coeem_hz_vec, res_hz0, res_hz1);
    MUL2(res_hz0, coeff_vt_vec1, res_hz1, coeff_vt_vec0, res_vt0, res_vt1);
                                          ...
                                          int32_t height)
{
    ...
    for (row = (height >> 2); row--;) {
        ...
        DOTP_UB4_UH(src0, src1, src2, src3, coeem_hz_vec, coeem_hz_vec,
                    coeem_hz_vec, coeem_hz_vec, res_hz0, res_hz1, res_hz2,
                    res_hz3);
                                 ...
                                 int32_t height)
{
    ...
    src0 = (v16u8) __msa_vshf_b(mask, (v16i8) src0, (v16i8) src0);
    res_hz0 = __msa_dotp_u_h(src0, coeem_hz_vec);
    ...
    for (row = (height >> 2); row--;) {
        ...
        DOTP_UB4_UH(src1, src2, src3, src4, coeem_hz_vec, coeem_hz_vec,
                    coeem_hz_vec, coeem_hz_vec, res_hz1, res_hz2, res_hz3,
                    res_hz4);
