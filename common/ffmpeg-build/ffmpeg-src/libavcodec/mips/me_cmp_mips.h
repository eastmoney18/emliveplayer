...
int em_hadamard8_diff8x8_msa(MpegEncContext *s, uint8_t *dst, uint8_t *src,
                             ptrdiff_t stride, int h);
int em_hadamard8_intra8x8_msa(MpegEncContext *s, uint8_t *dst, uint8_t *src,
                              ptrdiff_t stride, int h);
int em_hadamard8_diff16_msa(MpegEncContext *s, uint8_t *dst, uint8_t *src,
                            ptrdiff_t stride, int h);
int em_hadamard8_intra16_msa(MpegEncContext *s, uint8_t *dst, uint8_t *src,
                             ptrdiff_t stride, int h);
