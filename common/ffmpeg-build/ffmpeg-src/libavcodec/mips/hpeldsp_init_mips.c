...
#if HAVE_MSA
static void em_hpeldsp_init_msa(HpelDSPContext *c, int flags)
{
...
#if HAVE_MMI
static void em_hpeldsp_init_mmi(HpelDSPContext *c, int flags)
{
...
{
#if HAVE_MSA
    em_hpeldsp_init_msa(c, flags);
#endif  // #if HAVE_MSA
#if HAVE_MMI
    em_hpeldsp_init_mmi(c, flags);
#endif  // #if HAVE_MMI
}
