...
static av_cold void hevc_pred_init_msa(HEVCPredContext *c, const int bit_depth)
{
    if (8 == bit_depth) {
        ...
        c->pred_planar[0] = em_hevc_intra_pred_planar_0_msa;
        c->pred_planar[1] = em_hevc_intra_pred_planar_1_msa;
        c->pred_planar[2] = em_hevc_intra_pred_planar_2_msa;
        c->pred_planar[3] = em_hevc_intra_pred_planar_3_msa;
        c->pred_dc = em_hevc_intra_pred_dc_msa;
...
void em_hevc_pred_init_mips(HEVCPredContext *c, const int bit_depth)
{
#if HAVE_MSA
