...
#if HAVE_MSA
static av_cold void me_cmp_msa(MECmpContext *c, AVEMCodecContext *avctx)
{
#if BIT_DEPTH == 8
    ...
    c->hadamard8_diff[0] = em_hadamard8_diff16_msa;
    c->hadamard8_diff[1] = em_hadamard8_diff8x8_msa;

    c->hadamard8_diff[4] = em_hadamard8_intra16_msa;
    c->hadamard8_diff[5] = em_hadamard8_intra8x8_msa;
...
av_cold void ff_me_cmp_init_mips(MECmpContext *c, AVEMCodecContext *avctx)
{
#if HAVE_MSA
    me_cmp_msa(c, avctx);
#endif  // #if HAVE_MSA
