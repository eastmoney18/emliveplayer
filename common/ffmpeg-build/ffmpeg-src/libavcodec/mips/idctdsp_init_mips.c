...
#if HAVE_MSA
static av_cold void idctdsp_init_msa(IDCTDSPContext *c, AVEMCodecContext *avctx,
...
#if HAVE_MMI
static av_cold void idctdsp_init_mmi(IDCTDSPContext *c, AVEMCodecContext *avctx,
        unsigned high_bit_depth)
{
    if ((avctx->lowres != 1) && (avctx->lowres != 2) && (avctx->lowres != 3) &&
        (avctx->bits_per_raw_sample != 10) &&
...
av_cold void ff_idctdsp_init_mips(IDCTDSPContext *c, AVEMCodecContext *avctx,
                          unsigned high_bit_depth)
{
#if HAVE_MSA
