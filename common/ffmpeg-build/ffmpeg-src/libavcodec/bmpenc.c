...
static av_cold int bmp_encode_init(AVEMCodecContext *avctx){
...
static int bmp_encode_frame(AVEMCodecContext *avctx, AVEMPacket *pkt,
...
#define SIZE_BITMAPINFOHEADER 40
    ...
    if ((ret = em_alloc_packet2(avctx, pkt, n_bytes, 0)) < 0)
        return ret;
    buf = pkt->data;
