...
static int vdpau_vc1_start_frame(AVEMCodecContext *avctx,
...
static int vdpau_vc1_decode_slice(AVEMCodecContext *avctx,
                                  const uint8_t *buffer, uint32_t size)
{
    VC1Context * const v  = avctx->priv_data;
    MpegEncContext * const s = &v->s;
...
static int vdpau_vc1_init(AVEMCodecContext *avctx)
{
