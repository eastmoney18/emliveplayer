...
typedef struct FFPsyContext {
    AVEMCodecContext *avctx;            ///< encoder context
 ...
 */
int ff_psy_init(FFPsyContext *ctx, AVEMCodecContext *avctx, int num_lens,
 ...
 */
struct FFPsyPreprocessContext *ff_psy_preprocess_init(AVEMCodecContext *avctx);
