...
void AAC_RENAME(em_psdsp_init)(PSDSPContext *s);
void em_psdsp_init_arm(PSDSPContext *s);
void em_psdsp_init_mips(PSDSPContext *s);
void em_psdsp_init_x86(PSDSPContext *s);
