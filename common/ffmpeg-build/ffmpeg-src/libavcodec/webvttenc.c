...
static int webvtt_encode_frame(AVEMCodecContext *avctx,
...
static int webvtt_encode_close(AVEMCodecContext *avctx)
{
    WebVTTContext *s = avctx->priv_data;
...
static av_cold int webvtt_encode_init(AVEMCodecContext *avctx)
{
    WebVTTContext *s = avctx->priv_data;
    s->avctx = avctx;
