 ...
 */
static int latm_find_frame_end(AVEMCodecParserContext *s1, const uint8_t *buf,
                               int buf_size)
{
...
static int latm_parse(AVEMCodecParserContext *s1, AVEMCodecContext *avctx,
...
AVEMCodecParser em_aac_latm_parser = {
