...
extern const uint8_t *em_aac_swb_size_1024[];
extern const int      em_aac_swb_size_1024_len;
extern const uint8_t *em_aac_swb_size_128[];
extern const int      em_aac_swb_size_128_len;
