...
static int build_vlc(AVEMCodecContext *avctx, VLC *vlc, const uint32_t *table)
{
    Node nodes[512];
    uint32_t bits[256];
    int16_t lens[256];
                        ...
                        AVEMPacket *avpkt)
{
    ...
    av_em_fast_malloc(&s->table_bits, &s->table_bits_size,
    ...
    av_em_fast_malloc(&s->bitstream_bits, &s->bitstream_bits_size,
