...
static int g729_parse(AVEMCodecParserContext *s1, AVEMCodecContext *avctx,
                     ...
                     const uint8_t *buf, int buf_size)
{
    ...
    if (em_combine_frame(pc, next, &buf, &buf_size) < 0 || !buf_size) {
        *poutbuf      = NULL;
        *poutbuf_size = 0;
        return buf_size;
    }
...
AVEMCodecParser ff_g729_parser = {
