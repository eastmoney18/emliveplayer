...
void em_horizontal_compose_haar0i##ext(int16_t *b, int16_t *tmp, int w);\
void em_horizontal_compose_haar1i##ext(int16_t *b, int16_t *tmp, int w);\
\
...
\
    em_horizontal_compose_haar0i##ext(b, tmp, w);\
\
    for (; x < w2; x++) {\
        b[2*x  ] = tmp[x];\
...
{\
    ...
    int16_t *tmp = (int16_t *)_tmp; \
\
    em_horizontal_compose_haar1i##ext(b, tmp, w);\
\
    for (; x < w2; x++) {\
        b[2*x  ] = (tmp[x] + 1)>>1;\
...
void em_horizontal_compose_dd97i_ssse3(int16_t *_b, int16_t *_tmp, int w);
...
static void horizontal_compose_dd97i_ssse3(uint8_t *_b, uint8_t *_tmp, int w)
{
    ...
    em_horizontal_compose_dd97i_ssse3(b, tmp, w);
