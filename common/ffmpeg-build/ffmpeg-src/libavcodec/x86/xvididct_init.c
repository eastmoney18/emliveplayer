...
av_cold void em_xvid_idct_init_x86(IDCTDSPContext *c, AVEMCodecContext *avctx,
                                   unsigned high_bit_depth)
{
    ...
    if (EXTERNAL_MMXEXT(cpu_flags)) {
        ...
        c->idct      = em_xvid_idct_mmxext;
        c->perm_type = FF_IDCT_PERM_NONE;
    }
#endif

    if (EXTERNAL_SSE2(cpu_flags)) {
        c->idct_put  = em_xvid_idct_put_sse2;
        c->idct_add  = em_xvid_idct_add_sse2;
        c->idct      = em_xvid_idct_sse2;
