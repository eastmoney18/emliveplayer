...
static int adx_encode_header(AVEMCodecContext *avctx, uint8_t *buf, int bufsize)
{
...
static av_cold int adx_encode_init(AVEMCodecContext *avctx)
{
    ADXContext *c = avctx->priv_data;
...
static int adx_encode_frame(AVEMCodecContext *avctx, AVEMPacket *avpkt,
...
AVEMCodec ff_adpcm_adx_encoder = {
    .name           = "adpcm_adx",
