...
void em_hpeldsp_init(HpelDSPContext *c, int flags);

void em_hpeldsp_init_aarch64(HpelDSPContext *c, int flags);
void em_hpeldsp_init_alpha(HpelDSPContext *c, int flags);
void em_hpeldsp_init_arm(HpelDSPContext *c, int flags);
void em_hpeldsp_init_ppc(HpelDSPContext *c, int flags);
void em_hpeldsp_init_x86(HpelDSPContext *c, int flags);
void em_hpeldsp_init_mips(HpelDSPContext *c, int flags);
