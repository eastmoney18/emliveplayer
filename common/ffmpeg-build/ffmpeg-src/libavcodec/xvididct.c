...
av_cold void em_xvid_idct_init(IDCTDSPContext *c, AVEMCodecContext *avctx)
{
    ...
    if (ARCH_X86)
        em_xvid_idct_init_x86(c, avctx, high_bit_depth);
    if (ARCH_MIPS)
        em_xvid_idct_init_mips(c, avctx, high_bit_depth);
