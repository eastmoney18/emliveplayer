...
void em_hevc_dsp_init(HEVCDSPContext *hpc, int bit_depth);

extern const int8_t em_hevc_epel_filters[7][4];
extern const int8_t em_hevc_qpel_filters[3][16];

void em_hevc_dsp_init_x86(HEVCDSPContext *c, const int bit_depth);
void em_hevcdsp_init_arm(HEVCDSPContext *c, const int bit_depth);
