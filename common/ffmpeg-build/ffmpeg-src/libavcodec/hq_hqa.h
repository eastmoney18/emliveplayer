...
extern const int32_t * const em_hq_quants[16][2][4];
extern const HQProfile em_hq_profile[NUM_HQ_PROFILES];

extern const uint8_t em_hq_ac_skips[NUM_HQ_AC_ENTRIES];
extern const int16_t em_hq_ac_syms [NUM_HQ_AC_ENTRIES];

int em_hq_init_vlcs(HQContext *c);
