...
int em_xvid_rate_control_init(struct MpegEncContext *s);
void em_xvid_rate_control_uninit(struct MpegEncContext *s);
float em_xvid_rate_estimate_qscale(struct MpegEncContext *s, int dry_run);
