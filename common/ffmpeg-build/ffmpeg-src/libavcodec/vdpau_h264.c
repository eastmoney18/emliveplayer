...
static void vdpau_h264_set_reference_frames(AVEMCodecContext *avctx)
{
    H264EMContext * const h = avctx->priv_data;
...
static int vdpau_h264_start_frame(AVEMCodecContext *avctx,
...
static int vdpau_h264_decode_slice(AVEMCodecContext *avctx,
                                   const uint8_t *buffer, uint32_t size)
{
...
static int vdpau_h264_end_frame(AVEMCodecContext *avctx)
{
    H264EMContext *h = avctx->priv_data;
...
static int vdpau_h264_init(AVEMCodecContext *avctx)
{
...
AVHWAccel em_h264_vdpau_hwaccel = {
    .name           = "h264_vdpau",
