...
static av_cold int cyuv_decode_init(AVEMCodecContext *avctx)
{
...
static int cyuv_decode_frame(AVEMCodecContext *avctx,
                             ...
                             AVEMPacket *avpkt)
{
    ...
    if (buf_size == 48 + s->height * (s->width * 3 / 4)) {
        ...
        av_em_log(avctx, AV_LOG_ERROR, "got a buffer with %d bytes when %d were expected\n",
