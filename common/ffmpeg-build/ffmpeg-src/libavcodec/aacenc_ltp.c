 ...
 * Encode LTP data.
 */
void em_aac_encode_ltp_info(AACEncContext *s, SingleChannelElement *sce,
                            int common_window)
{
    int i;
...
void em_aac_ltp_insert_new_frame(AACEncContext *s)
{
 ...
 */
void em_aac_update_ltp(AACEncContext *s, SingleChannelElement *sce)
{
...
void em_aac_adjust_common_ltp(AACEncContext *s, ChannelElement *cpe)
{
    int sfb, count = 0;
 ...
 * Mark LTP sfb's
 */
void em_aac_search_for_ltp(AACEncContext *s, SingleChannelElement *sce,
                           int common_window)
{
