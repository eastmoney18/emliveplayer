                      ...
                      int omethod, int max_shift, int zero_shift)
{
    ...
    if (lpc_type == FF_LPC_TYPE_CHOLESKY) {
        ...
        for(; pass<lpc_passes; pass++){
            avpriv_em_init_lls(&m[pass&1], max_order);
            ...
            avpriv_em_solve_lls(&m[pass&1], 0.001, 0);
        }
                        ...
                        enum FFLPCType lpc_type)
{
    ...
    s->windowed_buffer = av_em_mallocz((blocksize + 2 + FFALIGN(max_order, 4)) *
