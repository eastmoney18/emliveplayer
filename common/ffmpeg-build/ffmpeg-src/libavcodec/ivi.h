...
typedef struct IVI45DecContext {
    ...
    int             (*decode_pic_hdr)  (struct IVI45DecContext *ctx, AVEMCodecContext *avctx);
    int             (*decode_band_hdr) (struct IVI45DecContext *ctx, IVIBandDesc *band, AVEMCodecContext *avctx);
    int             (*decode_mb_info)  (struct IVI45DecContext *ctx, IVIBandDesc *band, IVITile *tile, AVEMCodecContext *avctx);
 ...
 *  @param[in]      avctx       AVEMCodecContext pointer
...
int ff_ivi_decode_frame(AVEMCodecContext *avctx, void *data, int *got_frame,
                        AVEMPacket *avpkt);
int ff_ivi_decode_close(AVEMCodecContext *avctx);
