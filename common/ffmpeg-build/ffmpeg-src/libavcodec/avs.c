...
static int
avs_decode_frame(AVEMCodecContext * avctx,
...
static av_cold int avs_decode_init(AVEMCodecContext * avctx)
{
    ...
    return em_set_dimensions(avctx, 318, 198);
}

static av_cold int avs_decode_end(AVEMCodecContext *avctx)
{
    AvsContext *s = avctx->priv_data;
