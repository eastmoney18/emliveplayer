...
int ff_vp56_init(AVEMCodecContext *avctx, int flip, int has_alpha);
int ff_vp56_init_context(AVEMCodecContext *avctx, VP56Context *s,
                          int flip, int has_alpha);
int ff_vp56_free(AVEMCodecContext *avctx);
