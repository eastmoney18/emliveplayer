    ...
    i = 0;
    {
        ...
        for (;;) {
            ...
            if (level == 127) {
                ...
                i += run;
                if (i > 63) {
                    av_em_log(a->avctx, AV_LOG_ERROR,
                        ...
                        AVEMPacket *avpkt)
{
    ...
    av_em_fast_padded_malloc(&a->bitstream_buffer, &a->bitstream_buffer_size, buf_size);
