...
void ff_fmt_convert_init(FmtConvertContext *c, AVEMCodecContext *avctx);

void ff_fmt_convert_init_aarch64(FmtConvertContext *c, AVEMCodecContext *avctx);
void ff_fmt_convert_init_arm(FmtConvertContext *c, AVEMCodecContext *avctx);
void ff_fmt_convert_init_ppc(FmtConvertContext *c, AVEMCodecContext *avctx);
void ff_fmt_convert_init_x86(FmtConvertContext *c, AVEMCodecContext *avctx);
