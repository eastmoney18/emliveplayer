                                  ...
                                  int height, intptr_t mx, intptr_t my, int width)
{
    ...
    pixel        *src       = (pixel*)_src;
    ptrdiff_t     srcstride = _srcstride / sizeof(pixel);
    const int8_t *filter    = em_hevc_qpel_filters[mx - 1];
    for (y = 0; y < height; y++) {
        for (x = 0; x < width; x++)
                                  ...
                                  int height, intptr_t mx, intptr_t my, int width)
{
    ...
    pixel        *src       = (pixel*)_src;
    ptrdiff_t     srcstride = _srcstride / sizeof(pixel);
    const int8_t *filter    = em_hevc_qpel_filters[my - 1];
    for (y = 0; y < height; y++)  {
        for (x = 0; x < width; x++)
                                   ...
                                   intptr_t my, int width)
{
    ...
    filter = em_hevc_qpel_filters[mx - 1];
    ...
    filter = em_hevc_qpel_filters[my - 1];
    for (y = 0; y < height; y++) {
        for (x = 0; x < width; x++)
                                  ...
                                  int height, intptr_t mx, intptr_t my, int width)
{
    ...
    pixel *src = (pixel *)_src;
    ptrdiff_t srcstride  = _srcstride / sizeof(pixel);
    const int8_t *filter = em_hevc_epel_filters[mx - 1];
    for (y = 0; y < height; y++) {
        for (x = 0; x < width; x++)
                                  ...
                                  int height, intptr_t mx, intptr_t my, int width)
{
    ...
    pixel *src = (pixel *)_src;
    ptrdiff_t srcstride = _srcstride / sizeof(pixel);
    const int8_t *filter = em_hevc_epel_filters[my - 1];
                                   ...
                                   int height, intptr_t mx, intptr_t my, int width)
{
    ...
    filter = em_hevc_epel_filters[my - 1];
