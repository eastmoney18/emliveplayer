...
static av_cold int qtrle_decode_init(AVEMCodecContext *avctx)
{
...
static int qtrle_decode_frame(AVEMCodecContext *avctx,
...
static av_cold int qtrle_decode_end(AVEMCodecContext *avctx)
{
    QtrleContext *s = avctx->priv_data;
