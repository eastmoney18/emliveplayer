...
uint8_t em_mpeg4_static_rl_table_store[3][2][2 * MAX_RUN + MAX_LEVEL + 3];
...
static inline void em_mpeg4_set_one_direct_mv(MpegEncContext *s, int mx,
                                              int my, int i)
{
...
int em_mpeg4_set_direct_mv(MpegEncContext *s, int mx, int my)
{
    ...
    if (IS_8X8(colocated_mb_type)) {
        ...
        for (i = 0; i < 4; i++)
            em_mpeg4_set_one_direct_mv(s, mx, my, i);
        ...
        em_mpeg4_set_one_direct_mv(s, mx, my, 0);
        s->mv[0][1][0] =
        s->mv[0][2][0] =
