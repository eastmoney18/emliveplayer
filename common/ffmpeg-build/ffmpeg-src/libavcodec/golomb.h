...
static inline int get_ue_golomb(GetBitContext *gb)
{
    ...
    if (buf >= (1 << 27)) {
        ...
        CLOSE_READER(re, gb);
        if (log < 7) {
            av_em_log(NULL, AV_LOG_ERROR, "Invalid UE golomb code\n");
                         ...
                         int line)
{
    ...
    av_em_log(NULL, AV_LOG_DEBUG, "%5d %2d %3d ue  @%5d in %s %s:%d\n",
                         ...
                         int line)
{
    ...
    av_em_log(NULL, AV_LOG_DEBUG, "%5d %2d %3d se  @%5d in %s %s:%d\n",
           bits, len, i, pos, file, func, line);
                         ...
                         int line)
{
    ...
    av_em_log(NULL, AV_LOG_DEBUG, "%5d %2d %3d te  @%5d in %s %s:%d\n",
           bits, len, i, pos, file, func, line);
