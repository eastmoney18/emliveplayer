...
static const AVEMClass g722_decoder_class = {
...
static av_cold int g722_decode_init(AVEMCodecContext * avctx)
{
...
static int g722_decode_frame(AVEMCodecContext *avctx, void *data,
...
AVEMCodec ff_adpcm_g722_decoder = {
    .name           = "g722",
