 ...
 */
void em_aac_encode_tns_info(AACEncContext *s, SingleChannelElement *sce)
{
...
/* Apply TNS filter */
void em_aac_apply_tns(AACEncContext *s, SingleChannelElement *sce)
{
    TemporalNoiseShaping *tns = &sce->tns;
 ...
 */
void em_aac_search_for_tns(AACEncContext *s, SingleChannelElement *sce)
{
    TemporalNoiseShaping *tns = &sce->tns;
    int w, g, count = 0;
