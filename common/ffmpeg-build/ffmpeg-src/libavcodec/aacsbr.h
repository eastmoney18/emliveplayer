...
/** Initialize SBR. */
void AAC_RENAME(em_aac_sbr_init)(void);
/** Initialize one SBR context. */
void AAC_RENAME(em_aac_sbr_ctx_init)(AACContext *ac, SpectralBandReplication *sbr);
/** Close one SBR context. */
void AAC_RENAME(em_aac_sbr_ctx_close)(SpectralBandReplication *sbr);
