 ...
 *
 */
void ff_mediacodec_sw_buffer_copy_yuv420_planar(AVEMCodecContext *avctx,
...
void ff_mediacodec_sw_buffer_copy_yuv420_semi_planar(AVEMCodecContext *avctx,
                                                     MediaCodecDecContext *s,
                                                     uint8_t *data,
                                                     size_t size,
                                                     FFAMediaCodecBufferInfo *info,
...
void ff_mediacodec_sw_buffer_copy_yuv420_packed_semi_planar(AVEMCodecContext *avctx,
                                                            MediaCodecDecContext *s,
                                                            uint8_t *data,
                                                            size_t size,
                                                            FFAMediaCodecBufferInfo *info,
...
void ff_mediacodec_sw_buffer_copy_yuv420_packed_semi_planar_64x32Tile2m8ka(AVEMCodecContext *avctx,
                                                                           MediaCodecDecContext *s,
                                                                           uint8_t *data,
                                                                           size_t size,
                                                                           FFAMediaCodecBufferInfo *info,
