...
static av_cold int y216_decode_init(AVEMCodecContext *avctx)
{
...
static int y216_decode_frame(AVEMCodecContext *avctx, void *data,
...
AVEMCodec ff_targa_y216_decoder = {
    .name         = "targa_y216",
