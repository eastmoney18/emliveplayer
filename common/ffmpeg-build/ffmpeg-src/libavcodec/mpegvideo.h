...
/* the following codec id fields are deprecated in favor of codec_id */
    ...
    int64_t user_specified_pts; ///< last non-zero pts from AVFrame which was passed into avcodec_em_encode_video2()
    /**
    ...
    AVEMRational mpeg2_frame_rate_ext;
...
#define MV_TYPE_DMV         4   ///< 2 vectors, special mpeg2 Dual Prime Vectors
    ...
    */
    ...
    int16_t direct_scale_mv[2][64];   ///< precomputed to avoid divisions in em_mpeg4_set_direct_mv
...
int ff_mpv_encode_init(AVEMCodecContext *avctx);
void ff_mpv_encode_init_x86(MpegEncContext *s);

int ff_mpv_encode_end(AVEMCodecContext *avctx);
...
int ff_mpeg_update_thread_context(AVEMCodecContext *dst, const AVEMCodecContext *src);
