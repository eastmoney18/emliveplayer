...
static av_cold int g723_1_decode_init(AVEMCodecContext *avctx)
{
                            ...
                            int gain, int *rseed)
{
    ...
    if (lag) { /* Voiced */
        ...
        av_em_memcpy_backptr((uint8_t*)(out + lag), lag * sizeof(*out),
...
static int g723_1_decode_frame(AVEMCodecContext *avctx, void *data,
...
static const AVEMClass g723_1dec_class = {
