...
typedef struct NvencContext
{
     ...
     * AVEMCodecContext.pix_fmt when using hwaccel frames on input */
...
int ff_nvenc_encode_init(AVEMCodecContext *avctx);

int ff_nvenc_encode_close(AVEMCodecContext *avctx);
