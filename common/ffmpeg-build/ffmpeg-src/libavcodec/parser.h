/*
 * AVEMCodecParser prototypes and definitions
 ...
 */
int em_combine_frame(ParseContext *pc, int next, const uint8_t **buf, int *buf_size);
int em_mpeg4video_split(AVEMCodecContext *avctx, const uint8_t *buf,
                        int buf_size);
