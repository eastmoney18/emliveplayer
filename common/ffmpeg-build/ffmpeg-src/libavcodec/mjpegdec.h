...
int ff_mjpeg_decode_init(AVEMCodecContext *avctx);
int ff_mjpeg_decode_end(AVEMCodecContext *avctx);
int ff_mjpeg_decode_frame(AVEMCodecContext *avctx,
