...
void em_h264dsp_init(H264DSPContext *c, const int bit_depth,
                     const int chroma_format_idc);
void em_h264dsp_init_aarch64(H264DSPContext *c, const int bit_depth,
                             const int chroma_format_idc);
void em_h264dsp_init_arm(H264DSPContext *c, const int bit_depth,
                         const int chroma_format_idc);
void em_h264dsp_init_ppc(H264DSPContext *c, const int bit_depth,
                         const int chroma_format_idc);
void em_h264dsp_init_x86(H264DSPContext *c, const int bit_depth,
                         const int chroma_format_idc);
void em_h264dsp_init_mips(H264DSPContext *c, const int bit_depth,
                          const int chroma_format_idc);
