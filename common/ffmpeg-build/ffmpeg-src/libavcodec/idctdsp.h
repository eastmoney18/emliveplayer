...
void ff_idctdsp_init(IDCTDSPContext *c, AVEMCodecContext *avctx);

void ff_idctdsp_init_alpha(IDCTDSPContext *c, AVEMCodecContext *avctx,
                           unsigned high_bit_depth);
void ff_idctdsp_init_arm(IDCTDSPContext *c, AVEMCodecContext *avctx,
                         unsigned high_bit_depth);
void ff_idctdsp_init_ppc(IDCTDSPContext *c, AVEMCodecContext *avctx,
                         unsigned high_bit_depth);
void ff_idctdsp_init_x86(IDCTDSPContext *c, AVEMCodecContext *avctx,
                         unsigned high_bit_depth);
void ff_idctdsp_init_mips(IDCTDSPContext *c, AVEMCodecContext *avctx,
                          unsigned high_bit_depth);
