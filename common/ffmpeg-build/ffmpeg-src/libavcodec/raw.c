...
const PixelFormatTag em_raw_pix_fmt_tags[] = {
...
{
    return em_raw_pix_fmt_tags;
}

unsigned int avcodec_em_pix_fmt_to_codec_tag(enum AVPixelFormat fmt)
{
    const PixelFormatTag *tags = em_raw_pix_fmt_tags;
...
const PixelFormatTag avpriv_em_pix_fmt_bps_avi[] = {
    { AV_PIX_FMT_PAL8,    1 },
    { AV_PIX_FMT_PAL8,    2 },
    { AV_PIX_FMT_PAL8,    4 },
    { AV_PIX_FMT_PAL8,    8 },
...
const PixelFormatTag avpriv_em_pix_fmt_bps_mov[] = {
    { AV_PIX_FMT_PAL8,      1 },
    { AV_PIX_FMT_PAL8,      2 },
    { AV_PIX_FMT_PAL8,      4 },
    { AV_PIX_FMT_PAL8,      8 },
