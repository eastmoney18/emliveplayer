...
static av_cold int truespeech_decode_init(AVEMCodecContext * avctx)
{
...
static int truespeech_decode_frame(AVEMCodecContext *avctx, void *data,
...
AVEMCodec ff_truespeech_decoder = {
    .name           = "truespeech",
