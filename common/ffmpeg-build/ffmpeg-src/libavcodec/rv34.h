...
int ff_rv34_decode_init(AVEMCodecContext *avctx);
int ff_rv34_decode_frame(AVEMCodecContext *avctx, void *data, int *got_frame, AVEMPacket *avpkt);
int ff_rv34_decode_end(AVEMCodecContext *avctx);
