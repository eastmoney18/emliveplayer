 ...
 */
av_cold void em_h264_pred_init(H264PredContext *h, int codec_id,
                               const int bit_depth,
...
\
    ...
    if (ARCH_AARCH64)
        em_h264_pred_init_aarch64(h, codec_id, bit_depth, chroma_format_idc);
    if (ARCH_ARM)
        em_h264_pred_init_arm(h, codec_id, bit_depth, chroma_format_idc);
    if (ARCH_X86)
        em_h264_pred_init_x86(h, codec_id, bit_depth, chroma_format_idc);
    if (ARCH_MIPS)
        em_h264_pred_init_mips(h, codec_id, bit_depth, chroma_format_idc);
}
