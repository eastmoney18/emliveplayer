...
typedef struct TwinVQContext {
    ...
    int (*read_bitstream)(AVEMCodecContext *avctx, struct TwinVQContext *tctx,
...
int ff_twinvq_decode_close(AVEMCodecContext *avctx);
int ff_twinvq_decode_init(AVEMCodecContext *avctx);
