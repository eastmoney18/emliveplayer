...
static int tmv_decode_frame(AVEMCodecContext *avctx, void *data,
...
static av_cold int tmv_decode_init(AVEMCodecContext *avctx)
{
    avctx->pix_fmt = AV_PIX_FMT_PAL8;
    return 0;
}

AVEMCodec ff_tmv_decoder = {
    .name           = "tmv",
