...
static int vdpau_mpeg_start_frame(AVEMCodecContext *avctx,
...
static int vdpau_mpeg_decode_slice(AVEMCodecContext *avctx,
                                   const uint8_t *buffer, uint32_t size)
{
    MpegEncContext * const s = avctx->priv_data;
    Picture *pic             = s->current_picture_ptr;
...
static int vdpau_mpeg1_init(AVEMCodecContext *avctx)
{
...
static int vdpau_mpeg2_init(AVEMCodecContext *avctx)
{
