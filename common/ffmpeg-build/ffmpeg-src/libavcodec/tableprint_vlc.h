...
#define AVUTIL_LOG_H
#define av_em_log(a, ...) while(0)
#define ff_dlog(a, ...) while(0)
#define AVUTIL_MEM_H
#define av_em_alloc(s) NULL
#define av_em_malloc_array(a, b) NULL
#define av_em_realloc_f(p, o, n) NULL
#define av_em_free(p) while(0)
#define av_em_freep(p) while(0)
