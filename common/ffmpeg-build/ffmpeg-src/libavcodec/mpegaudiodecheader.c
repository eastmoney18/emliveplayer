...
int ff_mpa_decode_header(uint32_t head, int *sample_rate, int *channels, int *frame_size, int *bit_rate, enum AVEMCodecID *codec_id)
{
...
#if LIBavcodec_em_version_MAJOR < 58
int avpriv_mpa_decode_header2(uint32_t head, int *sample_rate, int *channels, int *frame_size, int *bit_rate, enum AVEMCodecID *codec_id)
{
    return ff_mpa_decode_header(head, sample_rate, channels, frame_size, bit_rate, codec_id);
}

int avpriv_mpa_decode_header(AVEMCodecContext *avctx, uint32_t head, int *sample_rate, int *channels, int *frame_size, int *bit_rate)
{
