...
void ff_vp56dsp_init(VP56DSPContext *s, enum AVEMCodecID codec);
void ff_vp6dsp_init_arm(VP56DSPContext *s, enum AVEMCodecID codec);
void ff_vp6dsp_init_x86(VP56DSPContext* c, enum AVEMCodecID codec);
