...
struct AACISError em_aac_is_encoding_err(AACEncContext *s, ChannelElement *cpe,
...
void em_aac_search_for_is(AACEncContext *s, AVEMCodecContext *avctx, ChannelElement *cpe)
{
    SingleChannelElement *sce0 = &cpe->ch[0];
    SingleChannelElement *sce1 = &cpe->ch[1];
