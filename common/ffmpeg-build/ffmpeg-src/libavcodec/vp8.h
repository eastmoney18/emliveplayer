...
typedef struct VP8Context {
    ...
    void (*decode_mb_row_no_filter)(AVEMCodecContext *avctx, void *tdata, int jobnr, int threadnr);
    void (*filter_mb_row)(AVEMCodecContext *avctx, void *tdata, int jobnr, int threadnr);
...
int ff_vp8_decode_init(AVEMCodecContext *avctx);

int ff_vp8_decode_frame(AVEMCodecContext *avctx, void *data, int *got_frame,
                        AVEMPacket *avpkt);

int ff_vp8_decode_free(AVEMCodecContext *avctx);
