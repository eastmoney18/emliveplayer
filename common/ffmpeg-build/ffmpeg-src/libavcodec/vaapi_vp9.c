...
static int vaapi_vp9_start_frame(AVEMCodecContext          *avctx,
...
static int vaapi_vp9_end_frame(AVEMCodecContext *avctx)
{
    FFVAContext * const vactx = ff_vaapi_get_context(avctx);
    const VP9SharedContext *h = avctx->priv_data;
    int ret;
...
static int vaapi_vp9_decode_slice(AVEMCodecContext *avctx,
