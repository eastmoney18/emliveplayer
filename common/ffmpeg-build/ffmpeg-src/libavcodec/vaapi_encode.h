...
typedef struct VAAPIEncodeContext {
    ...
    AVEMBufferRef    *input_frames_ref;
    ...
    int          nb_recon_frames;
    AVEMBufferRef    *recon_frames_ref;
    ...
    // memory (in the AVEMCodec definition, set priv_data_size to
...
typedef struct VAAPIEncodeType {
    ...
    int (*close)(AVEMCodecContext *avctx);

    size_t sequence_params_size;
    size_t picture_params_size;
    size_t slice_params_size;

    int  (*init_sequence_params)(AVEMCodecContext *avctx);
    int   (*init_picture_params)(AVEMCodecContext *avctx,
                                 VAAPIEncodePicture *pic);
    int     (*init_slice_params)(AVEMCodecContext *avctx,
                                 VAAPIEncodePicture *pic,
    ...
    int (*write_sequence_header)(AVEMCodecContext *avctx,
                                 char *data, size_t *data_len);
    int  (*write_picture_header)(AVEMCodecContext *avctx,
                                 VAAPIEncodePicture *pic,
                                 char *data, size_t *data_len);
    int    (*write_slice_header)(AVEMCodecContext *avctx,
                                 VAAPIEncodePicture *pic,
                                 VAAPIEncodeSlice *slice,
                                 char *data, size_t *data_len);

    int    (*write_extra_buffer)(AVEMCodecContext *avctx,
                                 VAAPIEncodePicture *pic,
                                 int index, int *type,
                                 char *data, size_t *data_len);
} VAAPIEncodeType;
...
int ff_vaapi_encode_init(AVEMCodecContext *avctx,
                         const VAAPIEncodeType *type);
int ff_vaapi_encode_close(AVEMCodecContext *avctx);
