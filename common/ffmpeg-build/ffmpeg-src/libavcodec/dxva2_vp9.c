...
static int fill_picture_parameters(const AVEMCodecContext *avctx, AVDXVAContext *ctx, const VP9SharedContext *h,
                                    DXVA_PicParams_VP9 *pp)
{
    int i;
    const AVPixFmtDescriptor * pixdesc = av_em_pix_fmt_desc_get(avctx->sw_pix_fmt);
...
static int dxva2_vp9_start_frame(AVEMCodecContext *avctx,
...
static int dxva2_vp9_decode_slice(AVEMCodecContext *avctx,
...
static int dxva2_vp9_end_frame(AVEMCodecContext *avctx)
{
