...
static int vaapi_mpeg2_start_frame(AVEMCodecContext *avctx, av_unused const uint8_t *buffer, av_unused uint32_t size)
{
...
static int vaapi_mpeg2_decode_slice(AVEMCodecContext *avctx, const uint8_t *buffer, uint32_t size)
{
