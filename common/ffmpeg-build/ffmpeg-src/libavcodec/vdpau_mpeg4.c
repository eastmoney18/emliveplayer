...
static int vdpau_mpeg4_start_frame(AVEMCodecContext *avctx,
...
static int vdpau_mpeg4_decode_slice(av_unused AVEMCodecContext *avctx,
...
static int vdpau_mpeg4_init(AVEMCodecContext *avctx)
{
...
AVHWAccel em_mpeg4_vdpau_hwaccel = {
    .name           = "mpeg4_vdpau",
