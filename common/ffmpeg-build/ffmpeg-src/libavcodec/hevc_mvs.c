...
#define DERIVE_TEMPORAL_COLOCATED_MVS                                   \
    derive_temporal_colocated_mvs(s, temp_col,                          \
                                  ...
                                  em_hevc_get_ref_list(s, ref, x, y))
 ...
 */
void em_hevc_luma_mv_merge_mode(HEVCContext *s, int x0, int y0, int nPbW,
...
void em_hevc_luma_mv_mvp_mode(HEVCContext *s, int x0, int y0, int nPbW,
                              int nPbH, int log2_cb_size, int part_idx,
                              int merge_idx, MvField *mv,
