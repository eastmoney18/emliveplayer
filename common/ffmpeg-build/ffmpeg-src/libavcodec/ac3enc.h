...
typedef struct AC3EncodeContext {
    AVEMClass *av_class;                      ///< AVEMClass used for AVOption
...
int ff_ac3_encode_init(AVEMCodecContext *avctx);
int ff_ac3_float_encode_init(AVEMCodecContext *avctx);

int ff_ac3_encode_close(AVEMCodecContext *avctx);
...
int ff_ac3_fixed_encode_frame(AVEMCodecContext *avctx, AVEMPacket *avpkt,
                              const AVFrame *frame, int *got_packet_ptr);
int ff_ac3_float_encode_frame(AVEMCodecContext *avctx, AVEMPacket *avpkt,
                              const AVFrame *frame, int *got_packet_ptr);
