...
void AAC_RENAME(em_ps_init)(void);
void AAC_RENAME(em_ps_ctx_init)(PSContext *ps);
int AAC_RENAME(em_ps_read_data)(AVEMCodecContext *avctx, GetBitContext *gb, PSContext *ps, int bits_left);
