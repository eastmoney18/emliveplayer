 ...
 * av_em_opt_set_int(avr, "in_channel_layout",  AV_CH_LAYOUT_5POINT1, 0);
 * av_em_opt_set_int(avr, "out_channel_layout", AV_CH_LAYOUT_STEREO,  0);
 * av_em_opt_set_int(avr, "in_sample_rate",     48000,                0);
 * av_em_opt_set_int(avr, "out_sample_rate",    44100,                0);
 * av_em_opt_set_int(avr, "in_sample_fmt",      AV_SAMPLE_FMT_FLTP,   0);
 * av_em_opt_set_int(avr, "out_sample_fmt",     AV_SAMPLE_FMT_S16,    0);
 * @endcode
 *
 ...
 *
 *     av_em_samples_alloc(&output, &out_linesize, 2, out_samples,
 *                      AV_SAMPLE_FMT_S16, 0);
...
enum AVResampleFilterType {
    av_em_resample_FILTER_TYPE_CUBIC,              /**< Cubic */
    av_em_resample_FILTER_TYPE_BLACKMAN_NUTTALL,   /**< Blackman Nuttall Windowed Sinc */
    av_em_resample_FILTER_TYPE_KAISER,             /**< Kaiser Windowed Sinc */
};

enum AVResampleDitherMethod {
    av_em_resample_DITHER_NONE,            /**< Do not use dithering */
    av_em_resample_DITHER_RECTANGULAR,     /**< Rectangular Dither */
    av_em_resample_DITHER_TRIANGULAR,      /**< Triangular Dither*/
    av_em_resample_DITHER_TRIANGULAR_HP,   /**< Triangular Dither with High Pass */
    av_em_resample_DITHER_TRIANGULAR_NS,   /**< Triangular Dither with Noise Shaping */
    av_em_resample_DITHER_NB,              /**< Number of dither types. Not part of ABI. */
};
...
/**
 * Get the AVEMClass for AVAudioResampleContext.
 *
 ...
 * @see av_em_opt_find().
 *
 * @return AVEMClass for AVAudioResampleContext
 */
 ...
 * @see av_em_get_default_channel_layout()
 *
 ...
 * field will be set using avresample_get_out_samples() and av_em_frame_get_buffer()
