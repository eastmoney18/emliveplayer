...
struct AVAudioResampleContext {
    const AVEMClass *av_class;        /**< AVEMClass for logging and AVOptions  */
...
void em_audio_resample_init_aarch64(ResampleContext *c,
                                    enum AVSampleFormat sample_fmt);
void em_audio_resample_init_arm(ResampleContext *c,
                                enum AVSampleFormat sample_fmt);
