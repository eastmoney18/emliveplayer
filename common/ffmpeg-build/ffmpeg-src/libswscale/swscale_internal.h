...
typedef struct SwsContext {
     ...
     * em_sws_scale() wrapper so they can be freely modified here.
     */
    SwsFunc swscale;
...
#define RGB2YUV_SHIFT 15
    ...
    //Colorspace stuff
    int contrast, brightness, saturation;    // for em_sws_getColorspaceDetails
...
SwsFunc em_yuv2rgb_get_func_ptr(SwsContext *c);
int em_yuv2rgb_c_init_tables(SwsContext *c, const int inv_table[4],
                             int fullRange, int brightness,
                             int contrast, int saturation);
void em_yuv2rgb_init_tables_ppc(SwsContext *c, const int inv_table[4],
                                int brightness, int contrast, int saturation);

void em_updateMMXDitherTables(SwsContext *c, int dstY, int lumBufIndex, int chrBufIndex,
                           int lastInLumBuf, int lastInChrBuf);

av_cold void em_sws_init_range_convert(SwsContext *c);

SwsFunc em_yuv2rgb_init_x86(SwsContext *c);
SwsFunc em_yuv2rgb_init_ppc(SwsContext *c);
...
#if 0 // FIXME
#define isGray(x) \
    (!(av_em_pix_fmt_desc_get(x)->flags & AV_PIX_FMT_FLAG_PAL) && \
     av_em_pix_fmt_desc_get(x)->nb_components <= 2)
#else
#define isGray(x)                      \
    ((x) == AV_PIX_FMT_GRAY8       ||  \
     (x) == AV_PIX_FMT_YA8         ||  \
...
extern const uint64_t em_dither4[2];
extern const uint64_t em_dither8[2];

extern const uint8_t em_dither_2x2_4[3][8];
extern const uint8_t em_dither_2x2_8[3][8];
extern const uint8_t em_dither_4x4_16[5][8];
extern const uint8_t em_dither_8x8_32[9][8];
extern const uint8_t em_dither_8x8_73[9][8];
extern const uint8_t em_dither_8x8_128[9][8];
extern const uint8_t em_dither_8x8_220[9][8];

extern const int32_t em_yuv2rgb_coeffs[11][4];

extern const AVEMClass em_sws_context_class;

/**
 * Set c->swscale to an unscaled converter if one exists for the specific
 * source and destination formats, bit depths, flags, etc.
 */
void em_get_unscaled_swscale(SwsContext *c);
void em_get_unscaled_swscale_ppc(SwsContext *c);
void em_get_unscaled_swscale_arm(SwsContext *c);
void em_get_unscaled_swscale_aarch64(SwsContext *c);

/**
 * Return function pointer to fastest main scaler path function depending
 * on architecture and available optimizations.
 */
SwsFunc em_getSwsFunc(SwsContext *c);

void em_sws_init_input_funcs(SwsContext *c);
void em_sws_init_output_funcs(SwsContext *c,
                              yuv2planar1_fn *yuv2plane1,
                              yuv2planarX_fn *yuv2planeX,
                              yuv2interleavedX_fn *yuv2nv12cX,
                              yuv2packed1_fn *yuv2packed1,
                              ...
                              yuv2packedX_fn *yuv2packedX,
                              yuv2anyX_fn *yuv2anyX);
void em_sws_init_swscale_ppc(SwsContext *c);
void em_sws_init_swscale_x86(SwsContext *c);
void em_sws_init_swscale_aarch64(SwsContext *c);
void em_sws_init_swscale_arm(SwsContext *c);

void em_hyscale_fast_c(SwsContext *c, int16_t *dst, int dstWidth,
                       const uint8_t *src, int srcW, int xInc);
void em_hcscale_fast_c(SwsContext *c, int16_t *dst1, int16_t *dst2,
                       int dstWidth, const uint8_t *src1,
                       const uint8_t *src2, int srcW, int xInc);
int em_init_hscaler_mmxext(int dstW, int xInc, uint8_t *filterCode,
                           int16_t *filter, int32_t *filterPos,
                           int numSplits);
void em_hyscale_fast_mmxext(SwsContext *c, int16_t *dst,
                            int dstWidth, const uint8_t *src,
                            int srcW, int xInc);
void em_hcscale_fast_mmxext(SwsContext *c, int16_t *dst1, int16_t *dst2,
                            int dstWidth, const uint8_t *src1,
                            const uint8_t *src2, int srcW, int xInc);

/**
 * Allocate and return an SwsContext.
 * This is like em_sws_getContext() but does not perform the init step, allowing
 * the user to set additional AVOptions.
 *
 * @see em_sws_getContext()
 */
struct SwsContext *em_sws_alloc_set_opts(int srcW, int srcH, enum AVPixelFormat srcFormat,
                                      int dstW, int dstH, enum AVPixelFormat dstFormat,
                                      int flags, const double *param);

int em_sws_alphablendaway(SwsContext *c, const uint8_t *src[],
                          int srcStride[], int srcSliceY, int srcSliceH,
                          uint8_t *dst[], int dstStride[]);
...
int em_init_slice_from_src(SwsSlice * s, uint8_t *src[4], int stride[4], int srcW, int lumY, int lumH, int chrY, int chrH, int relative);

// Initialize scaler filter descriptor chain
int em_init_filters(SwsContext *c);

// Free all filter data
int em_free_filters(SwsContext *c);
...
*/
int em_rotate_slice(SwsSlice *s, int lum, int chr);

/// initializes gamma conversion descriptor
int em_init_gamma_convert(SwsFilterDescriptor *desc, SwsSlice * src, uint16_t *table);

/// initializes lum pixel format conversion descriptor
int em_init_desc_fmt_convert(SwsFilterDescriptor *desc, SwsSlice * src, SwsSlice *dst, uint32_t *pal);

/// initializes lum horizontal scaling descriptor
int em_init_desc_hscale(SwsFilterDescriptor *desc, SwsSlice *src, SwsSlice *dst, uint16_t *filter, int * filter_pos, int filter_size, int xInc);

/// initializes chr pixel format conversion descriptor
int em_init_desc_cfmt_convert(SwsFilterDescriptor *desc, SwsSlice * src, SwsSlice *dst, uint32_t *pal);

/// initializes chr horizontal scaling descriptor
int em_init_desc_chscale(SwsFilterDescriptor *desc, SwsSlice *src, SwsSlice *dst, uint16_t *filter, int * filter_pos, int filter_size, int xInc);

int em_init_desc_no_chr(SwsFilterDescriptor *desc, SwsSlice * src, SwsSlice *dst);

/// initializes vertical scaling descriptors
int em_init_vscale(SwsContext *c, SwsFilterDescriptor *desc, SwsSlice *src, SwsSlice *dst);

/// setup vertical scaler functions
void em_init_vscale_pfn(SwsContext *c, yuv2planar1_fn yuv2plane1, yuv2planarX_fn yuv2planeX,
