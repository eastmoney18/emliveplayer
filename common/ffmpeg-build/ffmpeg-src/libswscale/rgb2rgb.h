...
void em_rgb64tobgr48_nobswap(const uint8_t *src, uint8_t *dst, int src_size);
void   em_rgb64tobgr48_bswap(const uint8_t *src, uint8_t *dst, int src_size);
void em_rgb48tobgr48_nobswap(const uint8_t *src, uint8_t *dst, int src_size);
void   em_rgb48tobgr48_bswap(const uint8_t *src, uint8_t *dst, int src_size);
void    em_rgb64to48_nobswap(const uint8_t *src, uint8_t *dst, int src_size);
void      em_rgb64to48_bswap(const uint8_t *src, uint8_t *dst, int src_size);
void    em_rgb24to32(const uint8_t *src, uint8_t *dst, int src_size);
void    em_rgb32to24(const uint8_t *src, uint8_t *dst, int src_size);
void em_rgb16tobgr32(const uint8_t *src, uint8_t *dst, int src_size);
void    em_rgb16to24(const uint8_t *src, uint8_t *dst, int src_size);
void em_rgb16tobgr16(const uint8_t *src, uint8_t *dst, int src_size);
void em_rgb16tobgr15(const uint8_t *src, uint8_t *dst, int src_size);
void em_rgb15tobgr32(const uint8_t *src, uint8_t *dst, int src_size);
void    em_rgb15to24(const uint8_t *src, uint8_t *dst, int src_size);
void em_rgb15tobgr16(const uint8_t *src, uint8_t *dst, int src_size);
void em_rgb15tobgr15(const uint8_t *src, uint8_t *dst, int src_size);
void em_rgb12tobgr12(const uint8_t *src, uint8_t *dst, int src_size);
void    em_rgb12to15(const uint8_t *src, uint8_t *dst, int src_size);

void em_shuffle_bytes_1230(const uint8_t *src, uint8_t *dst, int src_size);
void em_shuffle_bytes_3012(const uint8_t *src, uint8_t *dst, int src_size);
void em_shuffle_bytes_3210(const uint8_t *src, uint8_t *dst, int src_size);

void em_rgb24toyv12_c(const uint8_t *src, uint8_t *ydst, uint8_t *udst,
...
void em_sws_rgb2rgb_init(void);

void em_rgb2rgb_init_x86(void);
