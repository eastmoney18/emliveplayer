 ...
 */
av_cold SwsFunc em_yuv2rgb_init_ppc(SwsContext *c)
{
#if HAVE_ALTIVEC
    if (!(av_em_get_cpu_flags() & AV_CPU_FLAG_ALTIVEC))
        return NULL;
    ...
    case AV_PIX_FMT_NV21:
        ...
        case AV_PIX_FMT_RGB24:
            av_em_log(c, AV_LOG_WARNING, "ALTIVEC: Color Space RGB24\n");
            return altivec_yuv2_rgb24;
        case AV_PIX_FMT_BGR24:
            av_em_log(c, AV_LOG_WARNING, "ALTIVEC: Color Space BGR24\n");
            return altivec_yuv2_bgr24;
        case AV_PIX_FMT_ARGB:
            av_em_log(c, AV_LOG_WARNING, "ALTIVEC: Color Space ARGB\n");
            return altivec_yuv2_argb;
        case AV_PIX_FMT_ABGR:
            av_em_log(c, AV_LOG_WARNING, "ALTIVEC: Color Space ABGR\n");
            return altivec_yuv2_abgr;
        case AV_PIX_FMT_RGBA:
            av_em_log(c, AV_LOG_WARNING, "ALTIVEC: Color Space RGBA\n");
            return altivec_yuv2_rgba;
        case AV_PIX_FMT_BGRA:
            av_em_log(c, AV_LOG_WARNING, "ALTIVEC: Color Space BGRA\n");
    ...
    case AV_PIX_FMT_UYVY422:
        ...
        case AV_PIX_FMT_BGR32:
            av_em_log(c, AV_LOG_WARNING, "ALTIVEC: Color Space UYVY -> RGB32\n");
...
av_cold void em_yuv2rgb_init_tables_ppc(SwsContext *c,
