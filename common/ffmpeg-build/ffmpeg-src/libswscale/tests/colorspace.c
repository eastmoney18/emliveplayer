...
{
    int i, funcNum;
    uint8_t *srcBuffer = av_em_alloc(SIZE);
    uint8_t *dstBuffer = av_em_alloc(SIZE);
    int failedNum      = 0;
    int passedNum      = 0;
    ...
    av_em_log(NULL, AV_LOG_INFO, "memory corruption test ...\n");
    em_sws_rgb2rgb_init();
    ...
    for (funcNum = 0; ; funcNum++) {
        struct func_info_s {
            ...
            FUNC(2, 2, em_rgb12to15),
            FUNC(2, 2, rgb15to16),
            FUNC(2, 3, em_rgb15to24),
            FUNC(2, 4, rgb15to32),
            FUNC(2, 3, em_rgb16to24),
            FUNC(2, 4, rgb16to32),
            FUNC(3, 2, rgb24to15),
            FUNC(3, 2, rgb24to16),
            FUNC(3, 4, em_rgb24to32),
            FUNC(4, 2, rgb32to15),
            FUNC(4, 2, rgb32to16),
            FUNC(4, 3, em_rgb32to24),
            FUNC(2, 2, rgb16to15),
            FUNC(2, 2, em_rgb12tobgr12),
            FUNC(2, 2, em_rgb15tobgr15),
            FUNC(2, 2, em_rgb15tobgr16),
            FUNC(2, 3, rgb15tobgr24),
            FUNC(2, 4, em_rgb15tobgr32),
            FUNC(2, 2, em_rgb16tobgr15),
            FUNC(2, 2, em_rgb16tobgr16),
            FUNC(2, 3, rgb16tobgr24),
            FUNC(2, 4, em_rgb16tobgr32),
            ...
            FUNC(6, 6, em_rgb48tobgr48_nobswap),
            FUNC(6, 6, em_rgb48tobgr48_bswap),
            FUNC(8, 6, em_rgb64to48_nobswap),
            FUNC(8, 6, em_rgb64to48_bswap),
            FUNC(8, 6, em_rgb64tobgr48_nobswap),
            FUNC(8, 6, em_rgb64tobgr48_bswap),
            FUNC(0, 0, NULL)
        };
        int width;
        int failed = 0;
