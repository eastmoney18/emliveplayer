...
DECLARE_ALIGNED(8, const uint8_t, em_dither_2x2_4)[][8] = {
{  1,   3,   1,   3,   1,   3,   1,   3, },
{  2,   0,   2,   0,   2,   0,   2,   0, },
{  1,   3,   1,   3,   1,   3,   1,   3, },
};

DECLARE_ALIGNED(8, const uint8_t, em_dither_2x2_8)[][8] = {
{  6,   2,   6,   2,   6,   2,   6,   2, },
{  0,   4,   0,   4,   0,   4,   0,   4, },
{  6,   2,   6,   2,   6,   2,   6,   2, },
};

DECLARE_ALIGNED(8, const uint8_t, em_dither_4x4_16)[][8] = {
{  8,   4,  11,   7,   8,   4,  11,   7, },
{  2,  14,   1,  13,   2,  14,   1,  13, },
{ 10,   6,   9,   5,  10,   6,   9,   5, },
{  0,  12,   3,  15,   0,  12,   3,  15, },
...
DECLARE_ALIGNED(8, const uint8_t, em_dither_8x8_32)[][8] = {
...
DECLARE_ALIGNED(8, const uint8_t, em_dither_8x8_73)[][8] = {
...
#if 1
DECLARE_ALIGNED(8, const uint8_t, em_dither_8x8_220)[][8] = {
...
{
    const uint8_t * const d128 = em_dither_8x8_220[y&7];
    int i;
    unsigned acc = 0;
    int err = 0;
 ...
 * R/G/B LUT as generated by em_yuv2rgb_c_init_tables(), which takes care of
...
#undef b_r
        ...
        if (target == AV_PIX_FMT_RGB565 || target == AV_PIX_FMT_BGR565) {
            dr1 = em_dither_2x2_8[ y & 1     ][0];
            dg1 = em_dither_2x2_4[ y & 1     ][0];
            db1 = em_dither_2x2_8[(y & 1) ^ 1][0];
            dr2 = em_dither_2x2_8[ y & 1     ][1];
            dg2 = em_dither_2x2_4[ y & 1     ][1];
            db2 = em_dither_2x2_8[(y & 1) ^ 1][1];
        } else if (target == AV_PIX_FMT_RGB555 || target == AV_PIX_FMT_BGR555) {
            dr1 = em_dither_2x2_8[ y & 1     ][0];
            dg1 = em_dither_2x2_8[ y & 1     ][1];
            db1 = em_dither_2x2_8[(y & 1) ^ 1][0];
            dr2 = em_dither_2x2_8[ y & 1     ][1];
            dg2 = em_dither_2x2_8[ y & 1     ][0];
            db2 = em_dither_2x2_8[(y & 1) ^ 1][1];
        } else {
            dr1 = em_dither_4x4_16[ y & 3     ][0];
            dg1 = em_dither_4x4_16[ y & 3     ][1];
            db1 = em_dither_4x4_16[(y & 3) ^ 3][0];
            dr2 = em_dither_4x4_16[ y & 3     ][1];
            dg2 = em_dither_4x4_16[ y & 3     ][0];
            db2 = em_dither_4x4_16[(y & 3) ^ 3][1];
        }
        ...
        if (target == AV_PIX_FMT_RGB8 || target == AV_PIX_FMT_BGR8) {
            const uint8_t * const d64 = em_dither_8x8_73[y & 7];
            const uint8_t * const d32 = em_dither_8x8_32[y & 7];
            dr1 = dg1 = d32[(i * 2 + 0) & 7];
            db1 =       d64[(i * 2 + 0) & 7];
            dr2 = dg2 = d32[(i * 2 + 1) & 7];
            db2 =       d64[(i * 2 + 1) & 7];
...
av_cold void em_sws_init_output_funcs(SwsContext *c,
