...
void em_swri_resample_dsp_init(ResampleContext *c);
void em_swri_resample_dsp_x86_init(ResampleContext *c);
void em_swri_resample_dsp_arm_init(ResampleContext *c);
