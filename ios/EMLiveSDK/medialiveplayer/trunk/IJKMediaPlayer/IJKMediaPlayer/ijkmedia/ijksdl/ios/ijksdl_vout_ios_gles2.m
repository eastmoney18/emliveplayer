...
static void vout_present_overlay_buffer(void *env, void *opaque, SDL_VoutOverlay *overlay)
{
    FFPlayer *ffp = (FFPlayer *)opaque;
    ffp->video_present_callback(ffp->inject_opaque, (uint8_t *)SDL_VoutOverlayVideoToolBox_GetCVPixelBufferRef(overlay), 0, overlay->w, overlay->h, 0);
}
...
SDL_Vout *SDL_VoutIos_CreateForGLES2()
{
    ...
    vout->present_overlayBuffer = vout_present_overlay_buffer;
    return vout;
}
