...
static bool ff_avpacket_is_idr(const AVEMPacket* pkt) {
...
static bool ff_avpacket_is_key(const AVEMPacket* pkt) {
...
static bool ff_avpacket_i_or_idr(const AVEMPacket* pkt,bool isIdr) {
    if (isIdr == true) {
