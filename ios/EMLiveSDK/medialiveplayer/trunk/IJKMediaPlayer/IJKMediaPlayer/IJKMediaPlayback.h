...
IJK_EXTERN NSString *const EMMPMediaPlaybackIsPreparedToPlayDidChangeNotification;
...
IJK_EXTERN NSString* const EMMPMoviePlayerPlaybackDidFinishNotification;
IJK_EXTERN NSString* const EMMPMoviePlayerPlaybackDidFinishReasonUserInfoKey; // NSNumber (IJKMPMovieFinishReason)

// Posted when the playback state changes, either programatically or by the user.
IJK_EXTERN NSString* const EMMPMoviePlayerPlaybackStateDidChangeNotification;

// Posted when the network load state changes.
IJK_EXTERN NSString* const EMMPMoviePlayerLoadStateDidChangeNotification;

// Posted when the movie player begins or ends playing video via AirPlay.
IJK_EXTERN NSString* const EMMPMoviePlayerIsAirPlayVideoActiveDidChangeNotification;
...
IJK_EXTERN NSString* const EMMPMovieNaturalSizeAvailableNotification;

// -----------------------------------------------------------------------------
//  Extend Notifications

IJK_EXTERN NSString *const EMMPMoviePlayerVideoDecoderOpenNotification;
IJK_EXTERN NSString *const EMMPMoviePlayerFirstVideoFrameRenderedNotification;
IJK_EXTERN NSString *const EMMPMoviePlayerFirstAudioFrameRenderedNotification;

IJK_EXTERN NSString *const EMMPMoviePlayerDidSeekCompleteNotification;
IJK_EXTERN NSString *const EMMPMoviePlayerDidSeekCompleteTargetKey;
IJK_EXTERN NSString *const EMMPMoviePlayerDidSeekCompleteErrorKey;

IJK_EXTERN NSString *const IJKMPMoviePlayerOpenHWVideoDecoderFailedNotification;
IJK_EXTERN NSString *const IJKMPMoviePlayerConnectSeverSuccessNotification;
IJK_EXTERN NSString *const IJKMPMoviePlayerNetDisconnectNotification;
IJK_EXTERN NSString *const IJKMPMoviePlayerNetReconnectNotification;
IJK_EXTERN NSString *const IJKMPMoviePlayerPlayProgressNotification;
IJK_EXTERN NSString *const IJKMPMoviePlayerPlayStreamUnixTimeNotification;

IJK_EXTERN NSString *const EMMPMediaPlaybackPreparedToPlayNotification;

// Voice
IJK_EXTERN NSString *const IJKAVMoviePlayerIsPreparedToPlayDidChangeNotification;
IJK_EXTERN NSString *const IJKAVMoviePlayerLoadedTimeNotification;
IJK_EXTERN NSString *const IJKAVMoviePlayerControllerPlayVoiceProgress;
IJK_EXTERN NSString *const IJKAVMoviePlayerControllerPlayVoiceFailed;
IJK_EXTERN NSString *const IJKAVMoviePlayerPlaybackDidFinishNotification;
IJK_EXTERN NSString *const IJKMPMoviePlayerNetForbiddenNotification;
...
@protocol IJKMediaVideoFrameDelegate <NSObject>
@optional
- (void)onVideoFrameRendering:(uint8_t *)data :(int)size :(int)width :(int)height :(int64_t)timems;

@end

@protocol IJKMediaAudioFrameDelegate <NSObject>
@optional
