...
typedef void(^LogBlock)(int level, NSString *content);
...
@interface EMFFMoviePlayerController : NSObject <IJKMediaPlayback>
...
@property(nonatomic) BOOL videoDisplay;
@property(nonatomic, assign) int rorationDegree;
...
@property (nonatomic, weak) id<IJKMediaVideoFrameDelegate> videoFrameDelegate;
@property (nonatomic, weak) id<IJKMediaAudioFrameDelegate> audioFrameDelegate;
@property (nonatomic, weak) id<IJKMediaNativeInvokeDelegate> nativeInvokeDelegate;
@property (nonatomic, retain) NSMutableDictionary *netStatInfo;
